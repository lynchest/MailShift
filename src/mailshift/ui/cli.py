...
def prompt_credentials(
    ...
    if provider == Provider.GMAIL:
        ...
        console.print(Panel(pt, title="[bold cyan]Gmail Åifre Durumu[/bold cyan]", border_style="cyan", box=box.ROUNDED))
...
def handle_uninstall() -> None:
    ...
    confirm = Confirm.ask(
        ...
        "  â€¢ Python paketleri (sadece proje dizinindekiler)\n"

        "  â€¢ Önbellek dosyaları (.db cache)\n"

        "  â€¢ Python __pycache__ klasörleri\n"
    ...
    if pycache.exists() and pycache.is_dir():
        ...
        items_removed.append("  â€¢ __pycache__/")
    ...
    for pf in base_path.glob("*.py"):
        ...
        try:
            ...
            items_removed.append(f"  â€¢ {pf.name}")
